...
public class VisualFallingBlockRenderer extends SaintsDragonsDeferredEntityRenderer<VisualFallingBlockEntity> {
    ...
    @Override
    protected void submitEntity(VisualFallingBlockEntity entity, RenderState<VisualFallingBlockEntity> renderState,
